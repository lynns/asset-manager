...
var cssproto = CSSAsset.prototype = new Asset;

cssproto.toHTML = function toHTML() {
  return "<link href='" + this.getRequestPath() + "' rel='stylesheet' media='" + this.mediaType + "'>";
};

cssproto.readContents = function readContents() {
 ...
 */
cssproto.extractMediaType = function extractMediaType(route){
  this.mediaType = 'all';
