...
cproto.getContents = function getContent() {
  ...
  var regex = /url\([^\)]+\)/g
  return content.replace(regex, resolveImgPath);
};
 ...
 * Declare exports
 */
exports.setSearchPaths = function setSearchPaths(paths){
  searchPaths = paths;
  contentResolver = require('./contentResolver')(paths);
};
...
exports.parseDiskPath = function parseDiskPath(diskPath, context, paths, servePath) {
  ...
  for(var i=0; i<paths.length; ++i) {
    ...
    if(diskPath.indexOf(aPath) === 0) {
      ...
      asset = exports.parse(route, context, servePath, true);
