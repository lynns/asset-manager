(function() {
  var MANIFEST_NAME, assets, async, builtAssets, expandPath, expandPaths, extractMediaType, extractRequestPaths, fs, glob, init, manifest, manifestLocation, path, paths, precompile, resolveAsset, resolveCSS, resolveInManifest, resolvers;
